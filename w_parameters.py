...
class Ui_ParamWindow(object):
    def setupUi(self, ParamWindow):
        ...
        self.lcdSteps.setGeometry(QtCore.QRect(190, 10, 161, 81))
        self.lcdSteps.setSmallDecimalPoint(False)
        self.lcdSteps.setProperty("value", 1.5)
        ...
        self.rotateNrBtn.setGeometry(QtCore.QRect(20, 20, 161, 61))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.cycleNrBtn.setGeometry(QtCore.QRect(20, 220, 161, 61))
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.lcdCycles.setGeometry(QtCore.QRect(190, 210, 161, 81))
